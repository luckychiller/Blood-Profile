   ...
   <body>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           ...
                           <p class="banner_text">This is a machine learning project aimed to improve the health system in peoples lives. with use you can just submit an image of blood under a microscope and get blood profile results.. or do a simple test to check on your attention and focus levels. <br><br><br><br> </p>
                        </div>
                        <div class="col-sm-6">
                           <div class="banner_img"><img src="images/homeBarnner.png"></div>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <div class="product_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="product_taital">What would you like to check out</h1>
               </div>
            </div>
         </div>
      </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="about_taital_main">
                        <h1 class="about_taital">Blood Profile</h1>
                        ...
                        <div class="readmore_bt"><a href="bloodCheck.jsp">Lets Go</a></div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div><img src="images/bloodBarnner.jpg" class="image_3"></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="about_section">
         <div class="container">
            <div class="about_section_main">
               <div class="row">
                  <div class="col-md-6">
                     <div><img src="images/focusBanner.png" class="image_3"></div>
                  </div>
                  <div class="col-md-6">
                     <div class="about_taital_main">
                        <h1 class="about_taital">Focus Check</h1>
                        <p class="about_text">labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatlabore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatlabore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat</p>
                        <div class="readmore_bt"><a href="focusCheck.jsp">Lets Go</a></div>
                     </div>
                  </div>
               </div>
            </div>
